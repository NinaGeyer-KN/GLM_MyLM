...
- The intercept shows the value of the dependent varaible if all covariatees are 0. 
...
Explain/show how you can use mylm to find these values. --> Use the function on the model.
...
In this model, I probably would add sex again, because it seems to explain a large proportion of variance.  
